...
public class Administrator extends UserData {
	 ...
	 */
	 ...
	 public void adminLogin(Administrator admin)
	 {
		 ...
		 {
			 if(adminAccsessDatabase().administratorList.get(i).getUsername().equals(admin.getUsername()) &&
					 adminAccsessDatabase().administratorList.get(i).getPassword().equals(admin.getPassword()))
			 {
